...
def callback(image, boxes):
    global frame_count, up_count, down_count, blue_list, yellow_list, cur_frame, polygon_mask_blue_and_yellow, polygon_color_image, point_roi
    ...
    polygon_mask_blue_and_yellow,  polygon_color_image = traffic_count.line2polygon(line, 0, 10,  (1024, 1224))
